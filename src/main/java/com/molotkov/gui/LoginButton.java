...
import static com.molotkov.gui.SceneHolder.*;

public class LoginButton extends ChangeableScene {

    public static Button createLoginButton(final Stage primaryStage, final Connection connection, User user, final Inventory shopInventory,
    ...
    private static void loginAction(final Stage primaryStage, final Connection connection, User user, final Inventory shopInventory,
                                    final Basket clientBasket, final List<Order> userOrders, final List<User> userList) {
