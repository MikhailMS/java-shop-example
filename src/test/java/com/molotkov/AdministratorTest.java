...
public class AdministratorTest {
    ...
    public void setUp() throws SQLException {
        ...
        statement.addBatch("CREATE TABLE IF NOT EXISTS products ( product_id serial, product_name text NOT NULL," +
                " product_weight numeric (6,3) NOT NULL, product_price numeric (8,2) NOT NULL, PRIMARY KEY ( product_id, product_name ) )");
